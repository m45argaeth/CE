...
import { ArrowDownUp, BarChart3, Layers, ArrowUpRight } from "lucide-react"
...
export function FeatureSections() {
  ...
  const sections = [
    { id: "simulation", icon: ArrowDownUp, ...t.features.simulation },
    { id: "comparison", icon: BarChart3, ...t.features.comparison },
    { id: "visualization", icon: Layers, ...t.features.visualization },
  ]
