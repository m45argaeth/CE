...
export type SiteId = "ebn" | "te" | "ttb" | "vfe" | "bd" | "ee" | "ce"
...
/** The educational playgrounds in the same series. Shared across every site. */
...
/** Portfolio hub that will host more playgrounds over time. */
...
export const SITE: {
  ...
  icon: FileDown,
  tagline: {
    id: "Bagaimana data menjadi lebih kecil.",
    en: "How data gets smaller.",
  },
}
